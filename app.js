...
import { AlertCircle, RefreshCw, Loader2, CheckCircle, Settings, MessageSquare, History, ThumbsUp, ThumbsDown, Plus, X } from 'lucide-react';

export default function BitbucketPRReviewer() {
        ...
        return (
            <div className="min-h-screen bg-gray-900 p-6">
                <div className="max-w-2xl mx-auto bg-gray-800 rounded-lg shadow-xl p-6">
                    <h1 className="text-2xl font-bold text-white mb-6">⚙️ Configuration</h1>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded text-white"
                            />
                            <p className="text-xs text-gray-400 mt-1">Create at: Bitbucket Settings → App passwords (needs pullrequest:read & write)</p>
                        </div>
        ...
        <div className="min-h-screen bg-gray-900 text-white">
            <div className="border-b border-gray-800 bg-gray-950">
                <div className="max-w-full mx-auto px-6 py-4 flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold">🤖 AI PR Reviewer</h1>
